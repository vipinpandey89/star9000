...
/* The function step1() is the controlling routine for setting up and displaying the objects
   ...
   function step1()
   {
     ...
     function step1_onSetFontBackColor(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl SetFontBackColor", status))
       {
         ...
         addTextObject(display_1.infoText, step1_onPutFont5);
       }
     }
     
     function step1_onPutFont5(wizCtlV, status)
     {
       if (callbackStatusOK("WizCtl PutFont5", status ))
       {
         if (display_1.step1agree.fontForeColor != "")
         {
           setFontForeColor(display_1.step1agree.fontForeColor, step1_onSetFontForeColorAgreeRadio);
         }
         else
         {
           addRadioButton( display_1.step1agree, step1_onAddRadioButton1);
         }
       }
     }
     
     function step1_onSetFontForeColorAgreeRadio()
     {
       if(callbackStatusOK("WizCtl SetFontForeColorAgreeRadio", status))
       {
         // If a foreground colour has been set then we assume a background colour must also be required
         setFontBackColor(display_1.step1agree.fontBackColor, step1_onSetFontBackColorAgreeRadio);
       }
     }
     
     function step1_onSetFontBackColorAgreeRadio(wizCtlV, status)
     {
     ...
     function step1_onAddRadioButton1(wizCtlV, status)
     {
       if (callbackStatusOK("WizCtl AddRadioButton1", status ))
       {
         addRadioButton(display_1.step1disagree, step1_onAddTextNextCont);
       }
     }
     ...
     if(wgssSignatureSDK.ResponseStatus.OK == status)
     {
       switch(id) 
       {
         ...
         case buttonEvent.CANCEL:
           ...
           break;
         default:
           print("Unexpected event:step 1 " + id);
           //alert("Unexpected event:  step 1" + id);
           break;
       }
     }
     else
   ...
   function step2()
   {
     ...
     function step2_onAddText1(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddObject", status))
       {
         ...
         {
            addLine(display_2.step2Line, step2_onAddPrimitive1);
         }
         else
         {
            addRectangle( display_2.step2Rectangle, step2_onAddPrimitive1);
         }
       }
     }
     ...
     function step2_onPutFont5(wizCtlV, status)
     {
       if (callbackStatusOK("WizCtl PutFont5", status ))
       {
         if (display_2.step2agree.fontForeColor != "")
         {
           setFontForeColor(display_2.step2agree.fontForeColor, step2_onSetFontForeColorStep2AgreeRadio);
         }
         else
         {
           addRadioButton( display_2.step2agree, step2_onAddRadioButton1);
         }
       }
     }
     
     function step2_onSetFontForeColorStep2AgreeRadio()
     {
       if(callbackStatusOK("WizCtl SetFontForeColorStep2AgreeRadio", status))
       {
         // If a foreground colour has been set then we assume a background colour must also be required
         setFontBackColor(display_2.step2agree.fontBackColor, step2_onSetFontBackColorStep2AgreeRadio);
       }
     }
     
     function step2_onSetFontBackColorStep2AgreeRadio(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl SetFontBackColorMaleRadio", status))
       {
         // After setting up the font colours set up the radio button itself
     ...
     function step2_onAddRadioButton1(wizCtlV, status)
     {
       if (callbackStatusOK("WizCtl AddRadioButton1", status ))
       {
         addRadioButton(display_2.step2disagree, step2_onAddRadioButton2);
       }
     }
   ...
   function step0_3()
   {
     wizCtl.Reset(step0_3_onWizCtlReset);
   
     function step0_3_onWizCtlReset(wizCtlV, status)
     {
       if(wgssSignatureSDK.ResponseStatus.OK == status)
       {
         setFont(display_0_3.stepMsg0_3.fontName, display_0_3.stepMsg0_3.fontSize, display_0_3.stepMsg0_3.fontWeight, false, step0_3_onPutFont);
       }
       else
       {
         print("WizCtl Reset" + status);
         if(wgssSignatureSDK.ResponseStatus.INVALID_SESSION == status)
         {
           actionWhenRestarted(window.step0_3);
         }
       }
     }
       
     function step0_3_onPutFont(wizCtlV, status)
     {
       var fontForeColor = "";
       ...
       if(callbackStatusOK("WizCtl PutFont", status))
       {
         ...
         if (pad.Range == padRange.STU5X0)
         {
           if (display_0_3.stepMsg0_3.fontForeColor != "")
           {
             fontForeColor = display_0_3.stepMsg0_3.fontForeColor;
           }
           else
           {
             fontForeColor = padColors.BLACK;
           }
           setFontForeColor(fontForeColor, step0_3_onSetstepMsg0_3FontForeColor);
         }
         else
         {
           // For monochrome pads skip the setting of font colours
           addTextObject(display_0_3.stepMsg0_3, step0_3_onAddText1);
         }
       }
     }
     
     function step0_3_onSetstepMsg0_3FontForeColor(wizCtlV, status)
     {
       var fontBackColor;
       
       if(callbackStatusOK("WizCtl setstepMsg0_3FontForeColor", status))
       {
         if (display_0_3.stepMsg0_3.fontBackColor != "")
         {
           fontBackColor = display_0_3.stepMsg0_3.fontBackColor;
         }
         else
         {
           fontBackColor = padColors.WHITE;
         }
         setFontBackColor(fontBackColor, step0_3_onSetstepMsg0_3FontBackColor);
       }
     }
     
     function step0_3_onSetstepMsg0_3FontBackColor(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl setstepMsg0_3FontBackColor", status))
       {
         addTextObject(display_0_3.stepMsg0_3, step0_3_onAddText1);
       }
     } 
     
     function step0_3_onAddText1(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddObject", status))
       {
         if (pad.Range == padRange.STU300)
         {
            addLine(display_0_3.step0_3Line, step0_3_onAddPrimitive1);
         }
         else
         {
            addRectangle( display_0_3.step0_3Rectangle, step0_3_onAddPrimitive1);
         }
       }
     }
     
     function step0_3_onAddPrimitive1(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl Primitive", status))
       {
         setFont(display_0_3.infoObject0_3.fontName, display_0_3.infoObject0_3.fontSize, display_0_3.infoObject0_3.fontBold, false, step0_3_onPutFont2);
       }
     }
     
     // Now add this text to the WizCtl: "Radio buttons provide options for the signing process and can be transferred to the document"
     function step0_3_onPutFont2(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl PutFont2", status))
       {
         /* If we are using a colour pad then set the colour of the foreground and background fonts up now if defined in the text object */
         if (display_0_3.infoObject0_3.fontForeColor != "")
         {
           setFontForeColor(display_0_3.infoObject0_3.fontForeColor, step0_3_onSetFontForeColorinfoObject0_3);
         }
         else
         {
           addTextObject(display_0_3.infoObject0_3, step0_3_onAddText3);
         }
       }
     }
     
     function step0_3_onSetFontForeColorinfoObject0_3(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl SetFontForeColorinfoObject0_3", status))
       {
         // If a foreground colour has been set then we assume a background colour must also be required
         setFontBackColor(display_0_3.infoObject0_3.fontBackColor, step0_3_onSetFontBackColorinfoObject0_3);
       }
     }
     
     function step0_3_onSetFontBackColorinfoObject0_3(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl SetFontBackColorinfoObject0_3", status))
       {
         // After setting up the font colours set up the text string itself
         addTextObject(display_0_3.infoObject0_3, step0_3_onAddText3);
       }
     ...
     function step0_3_onAddText3(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddText3", status))
       {
         addTextObject(display_0_3.nextToContinue, step0_3_onAddText4);
       }
     }
     
     function step0_3_onAddText4(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddText4", status))
       {
         setFont(pad.Font, pad.ButtonSize, pad.TextBold, false, step0_3_onPutFont5);
       }
     }
     
     function step0_3_onPutFont5(wizCtlV, status)
     {
       if (callbackStatusOK("WizCtl PutFont5", status ))
       {
         if (display_0_3.step0_3agree.fontForeColor != "")
         {
           setFontForeColor(display_0_3.step0_3agree.fontForeColor, step0_3_onSetFontForeColorstep0_3AgreeRadio);
         }
         else
         {
           addRadioButton( display_0_3.step0_3agree, step0_3_onAddRadioButton1);
         }
       }
     }
     
     function step0_3_onSetFontForeColorstep0_3AgreeRadio()
     {
       if(callbackStatusOK("WizCtl SetFontForeColorstep0_3AgreeRadio", status))
       {
         // If a foreground colour has been set then we assume a background colour must also be required
         setFontBackColor(display_0_3.step0_3agree.fontBackColor, step0_3_onSetFontBackColorstep0_3AgreeRadio);
       }
     }
     
     function step0_3_onSetFontBackColorstep0_3AgreeRadio(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl SetFontBackColorMaleRadio", status))
       {
         // After setting up the font colours set up the radio button itself
     ...
     function step0_3_onAddRadioButton1(wizCtlV, status)
     {
       if (callbackStatusOK("WizCtl AddRadioButton1", status ))
       {
         addRadioButton(display_0_3.step0_3disagree, step0_3_onAddRadioButton2);
       }
     }
     
     function step0_3_onAddRadioButton2(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddRadioButton2", status))
       {
         var buttonSource = getButtonSourceFromHTMLDoc();
         ...
         {
           // Set up font colours if required for colour pads
           if (display_0_3.cancelButton.fontForeColor != "")
           {
             setFontForeColor(display_0_3.cancelButton.fontForeColor, step0_3_onSetCancelButtonFontForeColor);
           }
           else
           {
             addButtonObject(display_0_3.cancelButton, step0_3_onAddCancelButton);
           }
         }
         else
         {
           //print("Adding button as an image from source " + buttonSource);
           addObjectImage(display_0_3.cancelButton, step0_3_onAddCancelButton, buttonSource);
         }
       }
     }
     
     function step0_3_onSetCancelButtonFontForeColor(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl step0_3_setFontCancelButtonForeColor", status))
       {
         setFontBackColor(display_0_3.cancelButton.fontBackColor, step0_3_onSetCancelButtonFontBackColor);
       }
     }
       
     function step0_3_onSetCancelButtonFontBackColor(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl step0_3_setCancelButtonFontBackColor", status))
       {
         addButtonObject(display_0_3.cancelButton, step0_3_onAddCancelButton);
       }
     }   
     
     function step0_3_onAddCancelButton(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddCancelButton", status))
       {
         var buttonSource = getButtonSourceFromHTMLDoc();
         ...
         if (buttonSource == textSource.STANDARD) 
         {
           addButtonObject(display_0_3.nextButton, step0_3_onAddNextButton);
         }
         else
         {
           addObjectImage(display_0_3.nextButton, step0_3_onAddNextButton, buttonSource);
         }
       }
     }
   
     function step0_3_onAddNextButton(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl AddNextButton", status))
       {
         wizCtl.Display(step0_3_onDisplay);
       }
     }
     
     function step0_3_onDisplay(wizCtlV, status)
     {
       if(callbackStatusOK("WizCtl Display", status))
       {
         wizCtl.SetEventHandler(step0_3_Handler);
       }
     }
   }
   
   /* This is the event handler for the user input on the second screen of the wizard */
   function step0_3_Handler(ctl, id, type, status)
   { 
     if(wgssSignatureSDK.ResponseStatus.OK == status)
     {
       switch(id) {
