	...
	<div class="error_page">												
		...
		<div class="error-top" style="width:32%;">
			...
			<div class="login">
				...
				<h3 class="inner-tittle t-inner">Cambia la password</h3>																

				<form method="post">

					<input type="password" class="" value="" placeholder="password" name="password" >
                    <input type="password" class="" value="" placeholder="conferma password" name="confirm_passwd" >
					<div class="submit"><input style="font-size:15px;" type="submit" value="cambia la password" ></div>
