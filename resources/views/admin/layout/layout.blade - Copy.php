...
<link href="{{URL::asset('administrator/css/barChart.css')}}" rel='stylesheet' type='text/css' />
	   ...
	   <div class="inner-content">
			...
			<div class="header-section">
				...
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Star 9000</h1></span> 
			...
			<div style="border-top:1px solid rgba(69, 74, 84, 0.7)"></div>
							...
							<div class="down">	
									  <a href="index.html"><img src="{{url('administrator/images/admin.jpg')}}"></a>
                           ...
                           <div class="menu">
									...
									<li><a href="{{url('admin/list-secretary')}}"><i class="lnr lnr-user"></i> <span>Secretary</span></a></li>

									<li><a href="{{url('admin/list-examination')}}"><i class="lnr lnr-user"></i> <span>Examination </span></a></li>
